...
The purpose of this document is to provide a reproducible record of all analyses and figures in the main article. 
Specifically, this document reproduce the same main analysis as in the main article, but excluding all extinct species from the analysis, as the inclusion of the many 0s, may change the results of the analysis.
...
complete_aggr<-aggr_ts_no_ext %>%group_by(composition,nutrients,temperature,sample_ID)%>%reframe(
